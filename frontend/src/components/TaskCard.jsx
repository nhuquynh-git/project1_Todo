...
import { Calendar,CheckCircle2,Circle,Trash2,SquarePen} from "lucide-react";
                ...
                <div className="flex-1 min-w-0">
                    {isEditting ? (
                        <Input
                            ...
                            className="w-full h-12 text-base border-border/50 focus:border-primary/50 focus:ring-primary/20"
                            type="text"
